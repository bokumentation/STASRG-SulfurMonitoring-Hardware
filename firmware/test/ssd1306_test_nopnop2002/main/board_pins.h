...
#define BOARD_HELTEC_WSL_ESP32S3_V3
    ...
    // - 0. Additional Pins
    #define PIN_RST_GPIO       -1
    #define PIN_USER_KEY       0  // GPIO_0: UNTESTED
    ...
    #define SO2_LOG_TAG   "TB600B_SO2"
        ...
        #define PIN_ANEMOMETER_ADC   34 // ADC1_CH3: UNTESTED
        #define PIN_WIND_DIR_ADC     33 // ADC1_CH4: UNTESTED
